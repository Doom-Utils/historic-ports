...
//			dmapx=0;  //goes into the automap.
	...
	{
                //memcpy(screens[0]+i*finit_width, maplump+j+mapxstart, finit_width-mapxstart);
                //memcpy(screens[0]+i*finit_width+finit_width-mapxstart, maplump+j, mapxstart);
                j += finit_width;
...
//       V_DrawPatchInDirect(0,0,0, maplump);
//       V_DrawPatchInDirect(0, 0, 0, W_CacheLumpName("AUTOPAGE", PU_CACHE));
}
