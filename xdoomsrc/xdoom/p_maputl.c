...
void P_UnsetThingPosition(mobj_t *thing)
{
	...
	//
	// If this Thing is beeing removed entirely, then the calling
	// routine will clean out the nodes in sector_list.
	sector_list = thing->touching_sectorlist;
	thing->touching_sectorlist = NULL; // restored by P_SetThingPosition
    }
...
//
// From Boom, by Lee Killough:
// Check for limit and double size if necessary
//
static void check_intercepts(void)
{
