...
void R_ExecuteSetViewSize (void)
{
	fixed_t	cosadj, dy;
	int		i,j, level, startmap;
        int             tempbarheight = (SCREENHEIGHT/200);

	setsizeneeded = false;


//
// BUG - Cannot adjust the screenwidth and height without the weapons
//       screwing up?  (crossbow, hellstaff, etc)
//
...
//                viewheight = (setblocks*158*tempbarheight/10);
//        }
