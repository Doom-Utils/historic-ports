...
//-----------------------------------------------------------------------------
//
// $Id: am_map.c,v 1.5 1998/01/27 15:42:10 pekangas Exp $
//
...
//
// $Log: am_map.c,v $
// Revision 1.5  1998/01/27 15:42:10  pekangas
...
const char am_map_rcsid[] = "$Id: am_map.c,v 1.5 1998/01/27 15:42:10 pekangas Exp $";
...
void AM_drawCrosshair(int color)
  ...
  if (BPP==1)
    ...
    tempbuffer=(short *)fb;
    fb[(f_w*(f_h+1))/2] = palette_color[color]; // single point for now
    }
}
