...
#define KEYH_TAB	9
#define AM_PANDOWNKEY	KEYH_DOWNARROW
#define AM_PANUPKEY	KEYH_UPARROW
#define AM_PANRIGHTKEY	KEYH_RIGHTARROW
#define AM_PANLEFTKEY	KEYH_LEFTARROW
...
#define AM_STARTKEY	KEYH_TAB
#define AM_ENDKEY	KEYH_TAB
