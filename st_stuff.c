...
int ST_X; // -ES- Changed this, to make low resolutions possible.
          // Also changed all occurances of (SCREENWIDTH-320)/2 to ST_X
...
// ST_ReInit
//
// Calculates stbar size and allocates memory for it
// -ES- 1999/03/29 Added This
void ST_AllocateSBar(void)
{
  int stbarwidth;
  ...
  if (SCREENWIDTH<320)
    ...
    stbarwidth = SCREENWIDTH;
  screens[4] = (byte *) Z_ReMalloc(screens[4],stbarwidth*BPP*ST_HEIGHT);
  ST_X = (stbarwidth-320)/2;
}
